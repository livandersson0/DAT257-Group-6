    ...
    <div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-label">utgångna varor</div>
        </div>
      </div>
  ...
  return (
    <div className="app">
      ...
      <main className="app-body">
        ...
        {tab === 'fridge'    && <FridgeTab   products={products} onDelete={handleDeleteRequest} />}
        {tab === 'add'       && <AddTab       onAdd={addProduct}  recentProducts={products} onDelete={handleDeleteRequest} />}
      ...
      {confirmDelete && (
        <div className="modal-overlay">
          <div className="modal">
            <h3>Ta bort vara?</h3>
            <p>Varför tar du bort den?</p>
            <button onClick={() => handleDeleteConfirm('ate')}>🍽️ Åt upp den</button>
            <button onClick={() => handleDeleteConfirm('threw')}>🗑️ Slängde den</button>
